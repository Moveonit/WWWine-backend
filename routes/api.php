...
$api->version('v1', function ($api) {
    ...
    $api->group(['namespace' => 'App\Http\Controllers\v1'], function ($api) {
        ...
        $api->post('/prova','UserController@prova');
        ...
        $api->group(['middleware' => 'jwt.auth'], function ($api) {
            ...
            $api->resource('/events', 'EventController',['only' => ['index', 'show', 'store', 'update', 'destroy']]);

            $api->resource('/tastings', 'TastingController',['only' => ['index', 'show', 'store', 'update', 'destroy']]);
